    ...
    public partial class CadastroCristalina : System.Web.UI.Page
    {
        ...
        private void CarregarDados(string token)
        {
            ...
            if (idProfissional > 0)
            {
                ...
                tbUF.Text = p3.ccUF;
                tbFone.Text = p1.cvTelefone.Value.ToString("00000000000");
                tbCelular.Text = p1.cvCelular.Value.ToString("00000000000");
                tbEmail.Text = p1.ccEmail;
                tbNaturalidade.Text = p1.ccNaturalCidade;
                tbUFNaturalidade.Text = p1.ccNaturalUF;
                tbDataNascimento.Text = p1.dtNascimento.Value.ToString("dd/MM/yyyy");
                tbRG.Text = p1.RGNum.ToString();
                tbDataExp.Text = p1.RGdtEmissao.Value.ToString("dd/MM/yyyy");
