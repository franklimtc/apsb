...
AS BEGIN      
	...
	BEGIN TRY        
		INSERT INTO tbProfissionalRepasse(idReceita, IdProfissional, cvValor, ccCriadoPor, cvTaxaProfissional)  
		VALUES(@idReceita, @IdProfissional, @cvValor, @UserName, @cvTaxa)  
		SET @Result = 1;      
	END TRY      
	BEGIN CATCH
