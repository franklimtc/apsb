...
AS BEGIN            
 ...
 BEGIN          
 SELECT             
 tbp.IdProfissional, tbp.ccNome, tbp.ccSexo, tbp.ccEmail, tbp.cvStatus, tbObs.observacao, tbp.cdDataNascimento, tbp.cdFiliacao, tbp.cdPgtoTaxa        
 ...
 BEGIN          
  SELECT             
 tbp.IdProfissional, tbp.ccNome, tbp.ccSexo, tbp.ccEmail, tbp.cvStatus, tbObs.observacao, tbp.ccNaturalUF, tbp.ccNaturalCidade, tbp.cdDataNascimento, tbp.cdFiliacao, tbp.cdPgtoTaxa     
