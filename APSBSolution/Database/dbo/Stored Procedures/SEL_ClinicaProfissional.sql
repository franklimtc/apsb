...
AS   
BEGIN  
	SELECT IdClinicaProfissional, tbc.idProfissional, tbp.ccNome, tbc.cvTaxaProfissional, tbc.cvStatus, tbo.observacao 
	...
	WHERE idClinica = @idClinica   AND tbc.cvStatus = 1
END