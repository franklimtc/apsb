...
AS BEGIN          
 ...
 , ccCriadoPor, IdObservacao, RGNum, RGEmissor, RGdtEmissao, CPFNum, cvTelefone, cvCelular, nomePai, nomeMae, nomeConjuge, cdDataNascimento,cdPgtoTaxa ,cdFiliacao, cdRegCartorio)         
 VALUES(@ccNome, @ccSexo, @ccNaturalUF, @ccNaturalCidade, @ccEstadoCivil, @ccEmail, @UserName, @IdObservacao, @RGNum        
 , @RGEmissor, @RGdtEmissao, @CPFNum, @cvTelefone, @cvCelular, @nomePai, @nomeMae, @nomeConjuge, @cdDataNascimento, @cdPgtoTaxa, @cdFiliacao, @cdRegCartorio);        
