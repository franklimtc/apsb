...
AS BEGIN    
 ...
 BEGIN TRY      
  ...
  , ccCriadoPor, IdObservacao, RGNum, RGEmissor, RGdtEmissao, CPFNum, cvTelefone, cvCelular, nomePai, nomeMae, nomeConjuge, cdDataNascimento)   
  VALUES(@ccNome, @ccSexo, @ccNaturalUF, @ccNaturalCidade, @ccEstadoCivil, @ccEmail, @UserName, @IdObservacao, @RGNum  
  , @RGEmissor, @RGdtEmissao, @CPFNum, @cvTelefone, @cvCelular, @nomePai, @nomeMae, @nomeConjuge, @cdDataNascimento);  
