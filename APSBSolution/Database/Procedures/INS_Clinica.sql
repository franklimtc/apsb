...
AS BEGIN  
	 ...
	 BEGIN TRY    
		  INSERT INTO tbClinicas(ccApelido, ccRazaoSocial, ccNomeFantasia, ccEmail, cvISS, cvDescontos, cbDescontoVariavel, idObservacao, idBanco, ccCriadoPor, cvPgtoDias, cvCNPJ)  
		  VALUES(@ccApelido, @ccRazaoSocial, @ccNomeFantasia, @ccEmail, @cvISS, @cvDescontos, @cbDescontoVariavel, @idObservacao, @idBanco, @UserName, @cvPgtoDias, @cvCNPJ);  
		  SET @Result = 1;  
	 END TRY  
	 BEGIN CATCH  
